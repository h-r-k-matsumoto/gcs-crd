...
func TestReconcile(t *testing.T) {
	...
	instance := &storagev1alpha1.Gcs{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Gcs object and expect the Reconcile and Deployment to be created
